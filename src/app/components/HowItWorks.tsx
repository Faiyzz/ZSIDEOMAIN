      ...
      <div className={cn("col-span-12 md:col-span-7", align === "right" ? "md:order-2" : "md:order-1")}> 
        ...
        >
          ...
          <motion.div style={{ y }} className="relative h-[220px] sm:h-[280px] md:h-[360px] lg:h-[420px]"> 
            <img src={step.imageSrc} alt={step.imageAlt || step.title} className="absolute inset-0 h-full w-full object-cover" />
            <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.05),rgba(0,0,0,0.25)_60%,rgba(0,0,0,0.35))]" />
            {/* moving sheen */}
            <motion.div style={{ left: sheenX }} aria-hidden className="pointer-events-none absolute top-0 h-full w-[35%] rotate-6 bg-gradient-to-r from-transparent via-white/20 to-transparent" />

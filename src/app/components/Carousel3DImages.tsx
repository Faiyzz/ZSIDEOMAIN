...
export default function Carousel3DImages({
  items,
  cardHeight, // unused for layout; height comes from parent via --car-h
  speedSec = 20,
  overlapPx = 12,
  ...
  return (
    <section id="carousel-images" className="w-screen h-full">
      <div
        ...
        style={
          {
            // expose overlap to CSS
            ["--overlap" as any]: `${overlapPx}px`,
            ["--speedSec" as any]: `${speedSec}s`,
      ...
      >
        <div
          ...
          style={{
            animation: isInView ? "scroll-x var(--speedSec) linear infinite" : "none",
          }}
          onMouseEnter={() => {
        ...
        >
          {loopItems.map((it, idx) => (
            <div
              ...
              style={{
                // height from parent (.h-full). Width solved by aspect-ratio.
                aspectRatio: "9 / 16",
                // tiny overlap except the first of each half
